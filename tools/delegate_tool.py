...
class DelegateTaskTool(BaseTool):
    ...
    description = (
        ...
        "single-step actions that are just as easy to do directly."
    )
    ...
    parameters = {
        ...
        "properties": {
            ...
            "max_turns": {
                "type": "integer",
                "description": "Maximum number of tool-call turns the sub-agent may take before giving up (default 6, hard cap 10)."
            }
        },
        "required": ["task"]
    }
